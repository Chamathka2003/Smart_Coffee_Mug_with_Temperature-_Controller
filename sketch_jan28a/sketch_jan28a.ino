...
float c1 = 0.001129148, c2 = 0.000127125, c3 = 0.0000000876741;  
...
if(temp<setL_temp){digitalWrite(heater, 0);}
              else{analogWrite(heater, (duty_cycle*2)+55); }
